Vue.component('book', {
    ...
    template: `
      ...
      <div class="book">
        ...
        <b-button-toolbar>
          <b-button-group>
            ...
            <b-button v-if="bookmarked" title="Remove Bookmark" @click="removeBookmark"><i class="fas fa-bookmark"></i>
            </b-button>
            <b-button v-else title="Add Bookmark" @click="addBookmark"><i class="far fa-bookmark"></i></b-button>

            <b-button v-if="favorite" title="Remove Favorite" @click="removeFavorite"><i class="fas fa-heart"></i>
            </b-button>
      ...
      <!-- BOOK MODAL -->
      <b-modal v-model="showDetails" size="xl" :title="book.volumeInfo.title" cancel-disabled lazy hide-footer
        ...
        <b-container fluid class="book-details">
          <b-row>
            <b-col sm="4" class="text-center col-preview">
              ...
              <b-button v-if="book.accessInfo.webReaderLink" :href="book.accessInfo.webReaderLink" target="_blank"
                        variant="primary" class="m-2">Preview
              </b-button>
              <b-button v-if="book.saleInfo.buyLink" :href="book.saleInfo.buyLink" target="_blank" variant="primary"
                        class="m-2">Buy Now
              </b-button>
            </b-col>
            <b-col sm="8" class="text-left col-details">
              <dl>
                ...
                <template v-if="book.volumeInfo.publisher">
                  <dt>Publisher</dt>
                  <dd>{{ book?.volumeInfo?.publisher ?? 'N/A' }}</dd>
                </template>
